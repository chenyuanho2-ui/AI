...
#define AI_NETWORK_MODEL_SIGNATURE     "0x26c1924efa5daf93976f9cc7dd0bd15c"
...
#define AI_TOOLS_DATE_TIME   "2026-03-17T20:35:11+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 784, 16, 1, 1), AI_STRIDE_INIT(4, 4, 3136, 50176, 50176),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 50920, 1, 1),
    50920, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 50176);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 50176);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 50240);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 50240);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 50880);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 50880);
    return true;
  }
